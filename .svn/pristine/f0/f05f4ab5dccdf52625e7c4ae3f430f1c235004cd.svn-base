...
(function () {
    ...
    var SelectChartDialog = (function (_super) {
        ...
        SelectChartDialog.prototype._applySetting = function () {
            ...
            if (self._dialogType === SelectChartDialog.dialogType.insertChart) {
                var orientation = self._selectedItem.dataOrientation;
                if (self._isSelectStockGroupChartType()) {
                    orientation = 1; //The stock chart needs orientation 1 to create, if not select chart, it will be 0.
                }
        ...
        SelectChartDialog.prototype._createChartOptions = function () {
            ...
            for (var i = 0; i < seriesCount; i++) {
                ...
                } else if (self._isSelectStockGroupChartType()) {
                    dataOrientation = 1;
                } else {
