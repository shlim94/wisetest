...
<link rel="stylesheet" type="text/css"
	href="${domain}${pageContext.request.contextPath}/css/style.css" />
<link rel="stylesheet" type="text/css"
	href="${domain}${pageContext.request.contextPath}/resources/main/css/style.css" />
</head>

<body class="body_bg">
    <div class="error_page">
    	<div class="error_img"><img src="${pageContext.request.contextPath}/images/error_img_03.png" alt=""></div>
        <div class="error_txt">
            <div class="error_txt01">
                <spring:message code="page.expired.session.m1"></spring:message>
            </div>
            <div class="error_txt02">
                <spring:message code="page.expired.session.m2"></spring:message>
            </div>
