 ...
 * 2019-08-01
 * 수정:		해더 드롭 기능 주석함
 * EDIT: 	disabled header drop and hover events
 * 			line #: (4469-4473, 4557)
 */
...
//			$(this.header.parent.element).css('display','none');
//			this.header.layoutManager.root.contentItems[0].callDownwards( 'setSize' );
//		}else{
