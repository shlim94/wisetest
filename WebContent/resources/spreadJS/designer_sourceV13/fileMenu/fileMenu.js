    ...
    var FileMenu = (function () {
        ...
        FileMenu.prototype._addExportListeners = function () {
            ...
            $("#export-csv").on('click', function (e) {
                ...
                var sheet = designer.wrapper.spread.getActiveSheetIndex();
                var exportOptions = {
                    ...
                    row: 0,
                    column: 0,
                    rowCount: designer.wrapper.spread.getSheet(sheet).getRowCount(),
                    columnCount: designer.wrapper.spread.getSheet(sheet).getColumnCount(),
                    rowDelimiter: '\n',
                    columnDelimiter: ',',
                };
