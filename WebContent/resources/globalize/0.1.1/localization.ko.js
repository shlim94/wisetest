Globalize.addCultureInfo( "ko", {
	messages: {
		...
		"Back": "뒤로",
		"OK": "OK",
		"dxCollectionWidget-noDataText": "조회할 데이터가 없습니다",
		"validation-required": "Required",
		"validation-required-formatted": "{0} is required",
		"validation-numeric": "숫자형식이 아닙니다",
		...
		"dxDateBox-validation-datetime": "날짜형식이 아닙니다",
		...
		"dxDataGrid-summaryCount": "카운트: {0}",
		"dxDataGrid-columnFixingFix": "Fix",
		"dxDataGrid-columnFixingUnfix": "Unfix",
		"dxDataGrid-columnFixingLeftPosition": "To the left",
		"dxDataGrid-columnFixingRightPosition": "To the right",
		"dxDataGrid-exportTo": "Export to",
		"dxDataGrid-exportToExcel": "엑셀파일 다운로드",
