...
//    	var path = WISE.Constants.context+"/resources/shp2geojson/dbf.js"
...
//            header = this.header = {},
        ...
        self.header.version = DBASE_LEVEL[s.readSI8()]
        ...
        self.header.lastUpdated = date

        // Number of records in file
        self.header.numRecords = s.readSI32()

        // Position of first data record
        self.header.firstRecordPosition = s.readSI16()

        // Length of one data record, including delete flag
        self.header.recordLength = s.readSI16()
        ...
        This byte can contain the sum of any of the above values. For example, the value 0x03 indicates the table has a structural .cdx and a Memo field.
        */
        self.header.flags = s.readSI8()

        // Code page mark
        self.header.codePageMark = s.readSI8()

        // Reserved; filled with zeros.
        s.offset += 2
    };
    
    this.readFieldDescriptions = function(){
        var s = this.stream,
            field
    ...
    this.readRecords = function(){
        var s = this.stream,
            numRecords = self.header.numRecords,
            recordsOffset = self.header.firstRecordPosition,
            recordSize = self.header.recordLength,
            fields = self.fields,
            numFields = fields.length,
            field, record
