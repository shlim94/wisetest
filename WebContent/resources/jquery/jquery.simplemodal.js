...
(function(b) {
    ...
    b.modal.impl = {
        ...
        height: function(_height) {
        	if (_height) {
        		this.d.container.css('height', _height);
        		return this;
        	} else {
        		return this.d.container.height();
        	}
        },
        create: function(a) {
            this.getDimensions();
        ...
        fixIE: function() {
            ...
            b.each([this.d.iframe || null, !this.o.modal ? null : this.d.overlay,
                ...
                if (e) {
                    var f = e[0].style;
                    f.position = "absolute";
                    if (2 > b) $(f).css("height", document.body.scrollHeight > document.body.clientHeight ? document.body.scrollHeight : document.body.clientHeight + "px"), $(f).css("width", document.body.scrollWidth > document.body.clientWidth ? document.body.scrollWidth : document.body.clientWidth + "px");
                    else {
                        var c, d;
                        a && a.constructor ===
