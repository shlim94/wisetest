...
<body>
	<div id="wrap">
		<div class="errorPage-container pageValid">
			...
			<div class="inner">
				<div class="txt-cont">
               		<strong><spring:message code="page.error.no.view.permission.report.m2"></spring:message></strong>
	                <p><spring:message code="page.error.no.view.permission.report.m1"></spring:message></p>
