...
public class MARIAConnector extends AbstractDataBaseConnector {

    @Override
    public void init() {
        this.url = "jdbc:mariadb://" + this.dataSetMaster.getDatabaseIp() + ":" + this.dataSetMaster.getDatabasePort();
